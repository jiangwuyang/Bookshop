...
public class RegisterServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//检验验证码是否正确
		//获取页面验证码
		String code_Client=request.getParameter("checkCode");
		
		//获取图片验证码
		String code_Session=(String) request.getSession().getAttribute("checkcode_session");
		//比较两个验证码是否一致
		if(!code_Client.equals(code_Session)) {
